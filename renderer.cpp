...
void Window::framebufferResizeCallback(GLFWwindow *old_window, int width, int height)
{
    auto cast_window = reinterpret_cast<Window *>(glfwGetWindowUserPointer(old_window));
    cast_window->framebufferResized = true;
    cast_window->width = width;
    cast_window->height = height;
}
...
void Device::pickPhysicalDevice()
{
    ...
    if (isDeviceSuitable(devices.at(1)))
    {
        physicalDevice = devices.at(1);
    }
    else
    {
...
Renderer::Renderer(Window &window, Device &device) : r_window{window}, device{device}
{
    recreateSwapChain();
